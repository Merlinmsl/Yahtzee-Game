...
void evaluateComputerMove(Player *player, int frequencies[], int recurs_n) {
    ...
    int score = 0;
    int saveCategory = -1; // Store a fallback upper section category if needed
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    if (bestCategory == -1 && saveCategory != -1) {
        bestCategory = saveCategory;
        bestScore = frequencies[saveCategory] * (saveCategory + 1);
    }
